...
const HomeScreen = ({ navigation, route }) => {
  ...
  const [dailyPhraseEnabled, setDailyPhraseEnabled] = useState(
    DB.getDailyPhraseSettings().enabled
  );
    ...
    <Screen.Screen>
      ...
      <Screen.Body>
        ...
        <View style={Styles.welcome.wrapper}>
          ...
          <Text style={Styles.welcome.sentence}>
            {Dictionary.HOME_SCREEN.SENTENCE}
          </Text>
        </View>
        <View style={Styles.timer.wrapper}>
          <View style={Styles.timer.leftSide.wrapper}>
            <View style={Styles.timer.leftSide.headerWrapper}>
              <Text style={Styles.timer.leftSide.headerText}>
                {Dictionary.HOME_SCREEN.TIMER.TITLE}
              </Text>
              <Switch
                ...
                onValueChange={(value) =>
                  handleDailyPhraseSwitch(value, notificationTime)
                }
          ...
          <TouchableOpacity
            style={Styles.timer.rightSide.wrapper}
            onPress={() => setDatePickerVisibility(true)}
          >
            <Text style={Styles.timer.rightSide.digitsText(dailyPhraseEnabled)}>
              {padTimeString(notificationTime.getHours())}
            </Text>
            <Text style={Styles.timer.rightSide.colon}>:</Text>
            <Text style={Styles.timer.rightSide.digitsText(dailyPhraseEnabled)}>
              {padTimeString(notificationTime.getMinutes().toString())}
            </Text>
          </TouchableOpacity>
          <DateTimePickerModal
          ...
          {randomItem ? (
            <Card
              ...
              customHeader={
                notificationTrigger
                  ? Dictionary.HOME_SCREEN.TIMER.TITLE
                  : Dictionary.HOME_SCREEN.RANDOM_ITEM.TITLE
              }
